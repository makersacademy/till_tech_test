module Discounts
  ...
  def discount_total_price
    ...
    net_total > discount_applied_at ?
      calculate_discount(net_total, discount_level) : 0
  end
  ...
  def discount_muffins
    ...
    matched_total =
              matched_order_lines.inject(0) { |memo, n| memo + line_price(n) }
    matched_total > 0 ? calculate_discount(matched_total, discount_level).
                                                                  round(2) : 0
  end
